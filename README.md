...
### KPI
#### Esperanza de vida(Aumento 1)
en primera instancia analizamos el comportamiento de la esperanza de vida, optando por países del continente americano y el continente de oceánica. Optamos por este alcance ya que notamos un gran contraste entre países de centro-Latinoamérica e islas de Oceanía con respecto a Norteamérica y países como Australia.
...
KPI incremento de  esperanza de vida 
...
---
#### Mortalidad infantil
El tercer objetivo a analizar en cuestión fue la tasa de mortalidad infantil, considerando el indicador ‘Mortality_rate_infant_total’, observando y analizando su evolución en los últimos 30 años. Para este análisis se opto por mencionar a los  países con mayor y menor tasa y ver su evolución a través del tiempo.
...
Para terminar, no podemos dejar afuera a dos potencias como Canadá y Estados Unidos, siendo los dos países con menor tasa de mortalidad infantil (5.30 Canadá ;6.80 USA)  ,dato muy importante por si piensas tener hijos.
En resumen, el objetivo planteado recae en aquellos países con una alta tasa de mortalidad en 1%, siendo esta una disminución de la tasa analizada con respecto al último año.
Tasa de Mortalidad Infantil Disminuida 1%= 
...
Este estudio se realizo con el objetivo de incrementar la tasa de fecundidad en aquellos países que tienen una muy baja tasa en un 1% con respecto al año 2019
